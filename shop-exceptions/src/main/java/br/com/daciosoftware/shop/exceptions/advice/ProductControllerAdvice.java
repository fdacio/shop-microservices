...
public class ProductControllerAdvice {
    ...
    public ErrorDTO handleIntegrityViolation(HttpServletRequest request, ProductIdentifieViolationException exception) {
        log.error("Shop Error: {}", exception.getMessage(), exception);
    ...
    public ErrorDTO handleReportPdf(HttpServletRequest request, ProductReportPdfException exception) {
        log.error("Shop Error: {}", exception.getMessage(), exception);
